  ...
  return (
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        ReVibe <span className="text-green-600">Eco Solutions</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
        Join our community in revolutionizing waste management for a more efficient and rewarding future!
        </p>
        {!loggedIn ? (
