...
const positionStackApiKey = 'e7e1bacf8b1b64fcc543356ccce305cc';
...
export default function ReportPage() {
  ...
  const handleLocationSearch = async (query: string) => {
    ...
    try {
      const response = await fetch(
        `http://api.positionstack.com/v1/forward?access_key=${positionStackApiKey}&query=${encodeURIComponent(query)}&limit=5`
      );
  ...
  const handleLocationSelect = (location: string) => {
    setNewReport({ ...newReport, location });
    setLocationSuggestions([]);
  };
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert in waste management and recycling. Analyze this image and provide:
        ...
        Format your response strictly as a JSON object without any markdown formatting or code blocks:
        {"wasteType":"type of waste","quantity":"estimated quantity with unit","confidence":number}`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="relative">
            ...
            {locationSuggestions.length > 0 && (
              <div className="absolute z-10 w-full mt-1 bg-white shadow-lg rounded-xl border border-gray-200">
